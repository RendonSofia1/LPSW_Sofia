...
//		String username = request.getParameter("username");
		...
		if (usuario.isValido() || usuario.isValidoEmail()) {
			...
			response.sendRedirect(request.getContextPath() + "/vista/privado/panel.jsp?usuario=" + email + "&optionPanel=panel");
		} else {
			request.setAttribute("errorMessage", "Usuario o contraeña incorrectos");
